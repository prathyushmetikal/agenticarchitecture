...
def extract_job_posting():
    ...
    aiml_job_link = (
        "https://www.naukri.com/artificial-intelligence-artificial-intelligence-architect-"
        "machine-learning-chatbot-jobs?k=artificial%20intelligence%2C%20artificial%20intelligence%20architect%2C%20"
        "machine%20learning%2C%20chatbot&nignbevent_src=jobsearchDeskGNB"
    )

    print(">>> Entering Playwright loader")
    loader = PlaywrightURLLoader(
        urls=[aiml_job_link],
        remove_selectors=["header", "footer"],  # strip noisy sections
